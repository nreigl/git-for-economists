...
# Introduction
- **WHY?**
  - Outreach: Good to stay in contact with other researchers, share skills
...
- [DONE] Git figure on title slide? Rewrite title logo .css in libs - made an alternative title slide; can get the "regular" title slide back by removing "seal: false" from YAML
